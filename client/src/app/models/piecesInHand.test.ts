...
describe('PiecesInHand model', () => {
    ...
    it('keeps track of captured pieces', () => {
        ...
        const pawn = new Pawn('black', false);
        p.add(pawn);
    ...
    it('tracks each player\'s pieces separately', () => {
        const p = new PiecesInHand();
        const p1Pawn = new Pawn('black', false);
        const p2Pawn = new Pawn('white', false);
        p.add(p1Pawn);
    ...
    it('compares pieces by equality', () => {
        const p = new PiecesInHand();
        const pawn1 = new Pawn('black', false);
        const pawn2 = new Pawn('black', false);
        p.add(pawn1);
    ...
    it('tracks different kinds of pieces', () => {
        ...
        const lance = new Lance('black', false);
        p.add(pawn);
        p.add(king);
        p.add(lance);
    ...
    it('can handle both objects and instances', () => {
        const pawn = new Pawn('black', false);
        const obj: Pawn = { type: 'pawn', player: 'black', promoted: false };
        const p = new PiecesInHand();
        p.add(pawn);
        p.add(obj);
    ...
    it('ignores promoted status when adding pieces', () => {
        const p = new PiecesInHand();
        p.add(new Pawn('black', false));
        p.add(new Pawn('black', true));
        expect(p.numberInHand(new Pawn('black', false))).to.equal(2);
        expect(p.numberInHand(new Pawn('black', true))).to.equal(2);
    });

    it('ignores promoted status when checking number in hand', () => {
        const p = new PiecesInHand();
        p.add(new Pawn('black', false));
        expect(p.numberInHand(new Pawn('black', true))).to.equal(1);
    });
});
